...
CORRECTION_BLOCK = """\
CORRECTIONS — your last reply described something that did not happen. The world
did not change the way you narrated it. Continue from the CURRENT SCENE above,
which is the truth, and do not repeat these mistakes. Do not apologise, explain,
or break character; just narrate what is actually the case.
{corrections}"""
